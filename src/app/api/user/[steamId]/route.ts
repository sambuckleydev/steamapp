...
export async function GET(request: Request, context: RouteContext) {
    ...
    const steamId = params.steamId; // STEAM_USER_ID
    const apiKey = process.env.STEAM_API_KEY;
    const url = `http://api.steampowered.com/IPlayerService/GetOwnedGames/v1/?key=${apiKey}&steamid=${steamId}?include_appinfo=true&include_extended_appinfo=true&format=json`;
